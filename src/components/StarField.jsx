...
export function StarField({ className }) {
  ...
  return (
    <svg viewBox="0 0 881 211" fill="white" aria-hidden="true" className={clsx(
        'pointer-events-none absolute w-[55.0625rem] origin-top-right rotate-[30deg] overflow-visible opacity-70', className)}>
      <defs>
        <filter id={blurId}>
